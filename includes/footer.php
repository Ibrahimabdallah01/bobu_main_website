                ...
                <div class="col-md-12 col-lg-6 pbmit-footer-right-info">
                    <div class="pbmit-footer-box pbmit-footer-box-1">
                        <a href="tel:+255 - 754-280-885">
                            ...
                            <span class="pbmit-footer-box-title">+255 - 754-280-885</span>
                        </a>
                    </div>
                    <div class="pbmit-footer-box pbmit-footer-box-2">
                        <a href="mailto:bobuincorptz@gmail.com">
                            <span class="pbmit-footer-box-icon">
                                <i class="pbmit-agrimo-icon pbmit-agrimo-icon-email-1"></i>
                            </span>
                            <span class="pbmit-footer-box-title">bobuincorptz@gmail.com</span>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    <div class="col-md-12 col-xl-4">
                        <div class="pbmit-footer-logo">
                            <img src="images/bobuclear.png" class="pbmit-main-logo" alt="">
                        </div>
                    </div>
                    <div class="col-md-12 col-xl-8 pbmit-footer-right">
                        <h3 class="pbmit-title">Professional & modern, a theme designed to help <br> your business stand
                            out from the rest.</h3>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <aside class="widget widget_text">
                        <div class="textwidget">
                            <div class="pbmit-footer-text">
                                The products we are currently distributing are Fertilizers, Herbicides, Fungicides,
                                Seeds, Drip Irrigation packages, Farm equipments and Veterinary from different Suppliers
                                in the country.
                            </div>
                ...
                <div class="pbmit-footer-widget-col-4 col-md-6 col-lg-3">
                    <aside class="widget">
                        ...
                        <div class="pbmit-contact-widget-line pbmit-contact-widget-address">
                            Soko kuu la kisutu, Gorofa ya nne <br> P.O.BOX 78269 <br> Dar es salaam, Tanzania
                        </div>
                    </aside>
                </div>
            </div>
    ...
    <div class="pbmit-footer-text-area">
        <div class="container">
            <div class="pbmit-footer-text-inner">
                <div class="row">
                    <div class="col-md-6">
                        <div class="pbmit-footer-copyright-text-area"> Copyright © 2024 <a href="index.html">BOBU</a>,
